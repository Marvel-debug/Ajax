        ...
        if (xhttp.readyState == 4 && xhttp.status == 200){
            ...
            document.getElementById('profile').innerHTML = `<div class="panel panel-default">
                                                                ...
                                                                <div class="panel-body">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        <span class="label label-primary">Public
                                                                            Repos ${user.public_repos}</span>
                                                                        <span class="label label-danger">Public
                                                                            Gists ${user.public_gists}</span>
                                                                        <br><br>
                                                                        <ul class="list-group">
